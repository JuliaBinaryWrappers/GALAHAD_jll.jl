...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/161f29abc157a56a494db70ad034c3d31124ee97/G/GALAHAD/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/ralna/GALAHAD.git (revision: `e5b872c27f2f8d597b91ef75896e8f02c0550ddc`)
...
* `ExecutableProduct`: `runbnls_sif_double`
* `ExecutableProduct`: `runbnls_sif_single`
...
* `ExecutableProduct`: `runnrek_sif_double`
* `ExecutableProduct`: `runnrek_sif_single`
...
* `ExecutableProduct`: `runsllsb_sif_double`
* `ExecutableProduct`: `runsllsb_sif_single`
* `ExecutableProduct`: `runsnls_sif_double`
* `ExecutableProduct`: `runsnls_sif_single`
...
* `ExecutableProduct`: `runtrek_sif_double`
* `ExecutableProduct`: `runtrek_sif_single`
